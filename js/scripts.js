...
! function(u) {
             ...
             //   });
                $("#wish-form").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $('.submit_form').html("<span class='spinner-border spinner-border-sm spinner-button role='status' aria-hidden='true'></span> Sending...");
                        $.ajax({
                            type: "POST",
                            url: form.action,
                            data: $(form).serialize(),
                            success: function (res) {
                                ...
                                $('.submit_form').html("<span class='h-lines'></span><span class='v-lines'></span>Gửi lời chúc");
                            },
                            error: function() {
                                $( "#loader").hide();
    ...
    $('.button-see').on('click', function() {
		...
		$.fancybox({
                ...
                beforeShow : function(){
                    $(".fancybox-wrap").addClass("gallery-fancybox");
                    $(".fancybox-inner").css("overflow", "off");
                },
            });
            return false
